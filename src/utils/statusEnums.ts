...
export const PhaseStatusMapping: Record<
  PhaseEnum,
  {
    label: string;
    color:
...
export const StatusE51Mapping: Record<
  StatusE51Enum,
  {
    label: string;
    color:
...
export const Type474Mapping: Record<
  Type94BEnum,
  {
    label: string;
    color:
...
export const Status841Mapping: Record<
  Status841Enum,
  {
    label: string;
    color:
...
export const Status109Mapping: Record<
  Status109Enum,
  {
    label: string;
    color:
...
export const SuiviAdministrativeStatusMapping: Record<
  SuiviAdministrativeStatusEnum,
  {
    label: string;
    color:
...
export const Status3BfMapping: Record<
  Status3BfEnum,
  {
    label: string;
    color:
...
export const RolesMapping: Record<
  RolesEnum,
  {
    label: string;
    color:
...
> = {
  ...
  "Bureau d'étude technique": {
    label: "Bureau d'étude technique",
    color: "success",
  },
  "Coordonnateur sécurité et protection de la santé": {
    label: "Coordonnateur sécurité et protection de la santé",
    color: "warning",
  },
  "Assistance maîtrise d’ouvrage hygiène et environnement": {
    label: "Assistance maîtrise d’ouvrage hygiène et environnement",
    color: "error",
  },
...
export const ProjectStatusMapping: Record<
  ProjectStatusEnum,
  {
    label: string;
    color:
...
export const Status900Mapping: Record<
  Status900Enum,
  {
    label: string;
    color:
