...
import DeleteStaffContent from '@components/dialogs/SubcontractorStaff-dialog/DeleteStaffContent'
...
const StaffDialog = ({ open, setOpen, id, setId, refetch }: StaffDialogProps) => {
  const handleClose = () => {
    setOpen(false)
    setId?.(0)
