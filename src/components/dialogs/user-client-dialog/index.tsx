...
import DeleteUserClientContent from "@components/dialogs/user-client-dialog/DeleteUserClientContent";
...
const UserClientDialog = ({
  ...
  const ContentComponent = DeleteUserClientContent
...
export default UserClientDialog;
