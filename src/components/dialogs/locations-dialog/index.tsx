...
import DeleteLocationsContent from './DeleteLocationsContent';
...
const LocationDialog = ({
  ...
  const dialogTitle = 'Supprimer le locations';

  const dialogDescription = 'Êtes-vous sûr de vouloir supprimer ce locations ?';

  const ContentComponent = DeleteLocationsContent;
