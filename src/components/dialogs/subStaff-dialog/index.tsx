...
import DeleteSubStaffContent from "@components/dialogs/subStaff-dialog/DeleteSubStaffContent";
...
const SubStaffDialog = ({
  ...
  const ContentComponent = DeleteSubStaffContent
