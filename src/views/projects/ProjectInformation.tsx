    ...
    <Card>
      ...
      <CardContent>
        <Grid container spacing={6} className='mbe-6'>
          <Grid item xs={12}>
            <CustomTextField fullWidth label='Nom de Projet' placeholder='Construction ADL' />
          </Grid>
          <Grid item xs={12} sm={6}>
            <CustomTextField fullWidth label='Code de Projet' placeholder='FXSK123U' />
          </Grid>
          <Grid item xs={12} sm={6}>
            <CustomTextField fullWidth label='Date de debut de projet' placeholder='2024-09-23' />
          </Grid>
        </Grid>
