...
type UserStaffInformationProps = {
  register: UseFormRegister<FormValidateUserStaffEditType>; // Register from react-hook-form
  errors: {
...
const UserStaffInformation: React.FC<UserStaffInformationProps> = ({register, errors}) => {
  return (
    <Card>
