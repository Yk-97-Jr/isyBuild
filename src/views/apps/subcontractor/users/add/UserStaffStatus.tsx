...
type UserStatusProps = {
  register: UseFormRegister<FormValidateUserStaffAddType>; // Adjust the type as necessary
  errors: {
...
const UserStaffStatus : React.FC<UserStatusProps> = ({register, errors})  => {
  return (
    <Card>
...
export default UserStaffStatus;
