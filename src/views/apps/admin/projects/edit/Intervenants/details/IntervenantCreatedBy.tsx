        ...
        {intervenantData ? (
          <>
            <Typography variant="h6" fontWeight="bold">
              {intervenantData.intervenant.created_by?.first_name} {intervenantData.intervenant.created_by?.last_name}
            </Typography>
            <Typography variant="body1">{intervenantData.intervenant.created_by?.email}</Typography>
            ...
            <div className='flex flex-col gap-2'>
              <div className='flex items-center flex-wrap gap-x-1.5'>
                ...
                <Typography>{formatDate(intervenantData.intervenant.created_at)}</Typography>
              </div>
              <div className='flex items-center flex-wrap gap-x-1.5'>
                <Typography className='font-medium' color='text.primary'>Mise à jour à:</Typography>
                <Typography>{formatDate(intervenantData.intervenant.updated_at)}</Typography>
              </div>
            </div>
          </>
        ) : (
