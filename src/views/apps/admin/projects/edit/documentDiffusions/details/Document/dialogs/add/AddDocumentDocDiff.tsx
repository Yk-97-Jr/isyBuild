...
import { useDocumentDiffusionUploadMutation } from "@/services/IsyBuildApi";
import DialogCloseButton from "@components/dialogs/DialogCloseButton";

import CustomTextField from "@core/components/mui/TextField";
import AddDocumentUpload from "./AddDocumentUpload";
import type { FormValidateDocumentUploadType } from "@/views/apps/admin/projects/edit/documentDiffusions/details/Document/dialogs/add/AddDocumentSchema";
...
const AddDocumentDocDiff = ({ open, setOpen, refetch }: AddProps) => {
  const { /* register */ handleSubmit /*  formState: {errors} */ } =
    useForm<FormValidateDocumentUploadType>({
  ...
  const [createuseDocumentDiffusion, { isLoading }] =
  ...
  const onSubmit: SubmitHandler<FormValidateDocumentUploadType> = async (
    data,
  ) => {
    try {
      console.log(files);
...
export default AddDocumentDocDiff;
