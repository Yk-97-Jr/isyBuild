...
import {useListTravailSupplementaireQuery} from '@/services/IsyBuildApi';

const AdditionalWorkList = () => {
  ...
  const {data, error, isLoading, isFetching, refetch} = useListTravailSupplementaireQuery({financeEnterpriseId:+financeId,page, pageSize});
  ...
  return (
    isFetching ?
      <AdditionalWorkTable pageSize={pageSize} setPageSize={setPageSize} page={page} setPage={setPage} data={clients}
...
export default AdditionalWorkList;
