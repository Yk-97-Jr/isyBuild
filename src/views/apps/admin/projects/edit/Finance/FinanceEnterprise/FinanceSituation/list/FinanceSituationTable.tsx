...
import FinanceSituationDialog from '@components/dialogs/Finance-situation'
...
type FinanceTypeWithAction = FinanceSituationRead & {
  action?: string
}
...
const FinanceSituationTable = ({
  ...
  const table = useReactTable({
    data: filteredData as FinanceSituationRead[],
    columns,
    filterFns: {
      fuzzy: fuzzyFilter
    },
  ...
  return (
    <>
      ...
      <FinanceSituationDialog open={open} setOpen={setOpen} id={id} setId={setId} refetch={refetch}/>
    </>
  )
}

export default FinanceSituationTable
