...
type LocalisationWithAction = LocalisationRead & {
  action?: string
}
...
const LocationsTable = ({
  ...
  const handleEditLocations = (id: number) => {
    console.log(id)
    console.log(`/${userRole}/locations/${id}/details`)
    router.push(`/${userRole}/locations/${id}/details`);
  }

  const handleDeleteLocations = (id: number) => {
    setOpen(true)
    setId(id)
  }

  const handleAddlocations = () => {
    router.push(`/${userRole}/locations/add`);
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({row}) => (
          <div className='flex items-center'>
            <IconButton onClick={() => handleEditLocations(row.original.id)}>
              <i className='tabler-edit text-textSecondary'/>
            </IconButton>
            <IconButton onClick={() => handleDeleteLocations(row.original.id)}>
        ...
        <div className='flex justify-between flex-col items-start md:flex-row md:items-center p-6 border-bs gap-4'>
          ...
          <div className='flex flex-col sm:flex-row max-sm:is-full items-start sm:items-center gap-4'>
            <DebouncedInput
              ...
              placeholder='Rechercher emplacement'
