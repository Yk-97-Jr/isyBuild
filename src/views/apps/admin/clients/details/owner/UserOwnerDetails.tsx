...
import UserInformation from "@views/apps/admin/clients/details/owner/UserInformation";
import UserStatus from "@views/apps/admin/clients/details/owner/UserStatus";
import UserCreatedBy from "@views/apps/admin/clients/details/owner/UserCreatedBy";
import UserOwnerEditHeader from "@views/apps/admin/clients/details/owner/UserOwnerEditHeader";
...
const UserOwnerDetails = () => {
  ...
  const {data: userData, isLoading: isLoadingQuery} = useClientsOwnerRetrieveQuery({
    clientId: +id,
  });

  const [assignUser, {isLoading: isLoadingCreate}] = useClientsOwnerAssignUpdateMutation();
  const [modifyassignedUser, {isLoading: isLoadingUpdate}] = useClientsOwnerUpdateUpdateMutation();
