...
function CommentsSection({docDiffData}: { docDiffData: DocumentDiffusionRead | undefined }) {
  ...
  // const [addComment, {isLoading: isAdding}] = useDiffusionIntervenantCommentCreateMutation();

  // Fetch comments with pagination
  const {data, isLoading, refetch, isFetching, error} = useDocumentDiffusionCommentsListQuery({
    diffusionIntervenantId: +docDiffData!.diffusion_list[0].id,
    page,
    pageSize: 100,
  });
  ...
  //       diffusionIntervenantId: +docDiffData!.diffusion_list[0].id,
  //       // @ts-expect-error
  //       diffusionIntervenantCommentCreateUpdateRequest: formDataToSend
  //     }).unwrap();
  //
  //
