...
import LotsEditInfo from '@/views/apps/client/lots/details/LotsEditInfo'
import LotsEditHeader from '@/views/apps/client/lots/details/LotsEditHeader'
import LotsAbout from '@/views/apps/client/lots/details/LotsAbout'

import type { FormValidateLotsEditType } from '@/views/apps/client/lots/details/schemaLots'
import type { SnackBarContextType } from '@/types/apps/snackbarType'
import { SnackBarContext } from '@/contexts/SnackBarContextProvider'

import { schemaLotsEdit } from '@/views/apps/client/lots/details/schemaLots'
