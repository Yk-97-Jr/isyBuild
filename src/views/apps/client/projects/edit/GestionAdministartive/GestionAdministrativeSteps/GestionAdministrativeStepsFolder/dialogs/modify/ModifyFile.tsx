...
import type {
  FormValidateFileUploadType} from "@views/apps/client/projects/edit/GestionAdministartive/GestionAdministrativeSteps/GestionAdministrativeStepsFolder/dialogs/add/AddFileSchema";
import {
  schemaFileUpload
} from "@views/apps/client/projects/edit/GestionAdministartive/GestionAdministrativeSteps/GestionAdministrativeStepsFolder/dialogs/add/AddFileSchema";
import AddFileUpload
  from "@views/apps/client/projects/edit/GestionAdministartive/GestionAdministrativeSteps/GestionAdministrativeStepsFolder/dialogs/add/AddFileUpload";
...
const ModifyFile = ({open, setOpen, refetch, id}: AddProps) => {
    ...
    const [updateDocument, {isLoading}] = useUpdateSuiviAdministrativeStepDocumentMutation();
