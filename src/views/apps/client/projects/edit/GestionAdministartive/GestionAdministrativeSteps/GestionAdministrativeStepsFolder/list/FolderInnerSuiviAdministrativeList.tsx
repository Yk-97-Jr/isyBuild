...
import FolderInnerSuiviAdministrativeListTable
  from "@views/apps/client/projects/edit/GestionAdministartive/GestionAdministrativeSteps/GestionAdministrativeStepsFolder/list/FolderInnerSuiviAdministrativeListTable";
