...
import SubcontractorAddHeader from '@/views/apps/client/subcontractor/add/SubcontractorAddHeader'
import SubcontractorAdresse from '@/views/apps/client/subcontractor/add/SubcontractorAdresse'

/* import AddLotToCompany from '@/views/apps/client/subcontractor/add/AddLotToCompany' */

import SubcontractorInfo from '@/views/apps/client/subcontractor/add/SubcontractorInfo'
...
import ClientStatus from '@/views/apps/client/subcontractor/add/AddLotToCompany'
