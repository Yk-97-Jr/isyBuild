...
import AddCategoryHeader from '@/views/apps/admin/product/category-list/add/AddCategoryHeader'


import CategoryInfo from '@/views/apps/admin/product/category-list/add/Categoryinfo'
